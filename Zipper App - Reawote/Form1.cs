...
namespace Zipper_App___Reawote
{
    public partial class Form1 : Form
    {
            ...
            else
            {
                foreach (var folder in selectedFolderPaths)
                {
                    ...
                    foreach (var item in items)
                    {
                        ...
                        checkedListBox1.Items.Insert(i, itemName);
                        i++;
                    }
                }
            }
        ...
        {
            string message = "1. Vyber složku/y, ve kterých se nachází složky s bitmapy pro převod (např. ADO).\n" +
                     "2. Klikni na VYGENERUJ CHECKBOXY PRO PŘEVOD DO .JPG a pomocí checkboxů označ, u kterých materálu chceš provést převod.\n" +
                     "3. Klikni na PŘEVEĎ DO .JPG";
